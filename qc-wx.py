...
# 软件
    ...
    'mok1':['自动做多参考态计算的程序MOKIT ','&mid=2247486051&idx=1&sn=88c54f08bb614f293e659b233ddeb26d&chksm=fe65cc09c912451f858c29f8ee28707f2df713c17450984dcf6280513272ba7761c5ce9650d7'],
    'mok3':['CASSCF初始轨道高效构建（一）：局域轨道 ','&mid=2247486290&idx=1&sn=f2ff27ee8bbe299ee68be03c303171c3&chksm=fe65cd38c912442eebc9f7e41c0f6e228f9ebed2f2bd5493a2eda3f1a4a1c07a4d25707a9989'],
# 综合教程
    'z1':['激发态计算之如何选取特定的分子轨道作为活性空间 ','&mid=2247484238&idx=1&sn=4f244a96c45dabdde29b103c2e8ef165&chksm=fe65c524c9124c32703430b2fca595e4c2928b7528a79ba478c34c30909a261d51979efac8ad'],
    'z8':['利用常见的程序做轨道局域化 ','&mid=2247485018&idx=1&sn=d97820ffde2e86f339dd5c257d5a424d&chksm=fe65c030c9124926db55cd5c999ebca8229b8e167c39226db883a2b869dd520ddd43aad3c648']
}
def update():
    f = open('qc-wx.md', 'w')
